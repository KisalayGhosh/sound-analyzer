...
class Application(Canvas,Filedata):
    ...
    def getSecondsInputAndCreate(self):
        ...
        try:
            ...
            if(seconds>0):
                ...
                options['parent'] = self
                file_path = filedialog.asksaveasfilename(**self.file_opt)
    ...
    def __init__(self, width, height,master=None):
        ...
        master.update()
        messagebox.showinfo("Welcome!", "You may start by either uploading a .wav file of your choice, or creating a new one!")
        self.timerFired()
